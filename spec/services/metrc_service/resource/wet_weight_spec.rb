  ...
  describe '#call' do
    ...
    before do
      ...
      stub_request(:get, "#{ENV['ARTEMIS_BASE_URI']}/api/v3/facilities/1568/resource_units?include=crop_variety")
        .to_return(body: { data: [{ id: '99', type: 'resource_units', attributes: { id: 99, conversion_si: 1.0, kind: 'weight', name: 'g Wet Material - Banana Split', unit_name: 'Gram', product_modifier: 'Wet Weight', options: { } }, relationships: { crop_variety: { data: { type: 'crop_varieties', id: 1 } } } }, { id: '100', type: 'resource_units', attributes: { id: 100, conversion_si: 1.0, kind: 'weight', name: 'g Waste - Banana Split', unit_name: 'Gram', product_modifier: 'Wet Weight', options: {} }, relationships: { crop_variety: { data: { type: 'crop_varieties', id: 1 } } } }], included: [{ type: 'crop_varieties', id: 1, attributes: { name: 'Banana Split' } }] }.to_json)
