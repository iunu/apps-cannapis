...
RSpec.describe MetrcService::Batch do
  ...
  context '#call' do
    ...
    describe 'with no completions' do
      ...
      it 'returns nil when no completions were found' do
        expect(subject.call(task)).to be_nil
      end
    end
