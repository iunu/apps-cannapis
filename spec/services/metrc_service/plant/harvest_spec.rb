    ...
    describe 'on a complete harvest' do
      ...
      before do
        ...
        stub_request(:post, 'https://sandbox-api-md.metrc.com/harvests/v1/finish?licenseNumber=LIC-0001')
          .with(
            body: [{ Id: '1A4FF010000002200000211', ActualDate: '2019-11-13T18:44:45' }].to_json,
            basic_auth: [METRC_API_KEY, integration.secret]
          )
          .to_return(status: 200, body: '', headers: {})
        ...
        stub_request(:post, 'https://sandbox-api-md.metrc.com/harvests/v1/removewaste?licenseNumber=LIC-0001')
          .with(
            body: [{ Id: '1A4FF010000002200000211', WasteType: nil, UnitOfWeight: 'Grams', WasteWeight: 50, ActualDate: '2019-11-13T18:44:45' }].to_json,
            basic_auth: [METRC_API_KEY, integration.secret]
          )
          .to_return(status: 200, body: '', headers: {})
      end
