  ...
  context '#call' do
    ...
    xdescribe 'on a partial harvest' do
      ...
      it 'calls metrc\'s manicure_plants method' do
        ...
        stub_request(:get, 'https://portal.artemisag.com/api/v3/facilities/1568/batches/96182?include=zone,zone.sub_stage,barcodes,items,custom_data,seeding_unit,harvest_unit,sub_zone')
