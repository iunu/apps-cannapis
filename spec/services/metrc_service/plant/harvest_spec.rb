  ...
  context '#call' do
    ...
    xdescribe 'on a partial harvest' do
      ...
      it 'calls metrc\'s manicure_plants method' do
        ...
        stub_request(:get, 'https://portal.artemisag.com/api/v3/facilities/1568/batches/96182?include=zone,zone.sub_stage,barcodes,custom_data,seeding_unit,harvest_unit,sub_zone,custom_data.custom_field')
    ...
    describe 'on a complete harvest' do
      ...
      before do
        ...
        stub_request(:get, "#{ENV['ARTEMIS_BASE_URI']}/api/v3/facilities/#{facility_id}/completions?filter%5Baction_type%5D=generate&filter%5Bparent_id%5D=#{completion_id}")
          .to_return(body: { data: generate_completions }.to_json)

        stub_request(:get, "#{ENV['ARTEMIS_BASE_URI']}/api/v3/facilities/#{facility_id}/resource_units?include=crop_variety")
