  ...
  describe '#call' do
    ...
    xcontext 'with a partial harvest' do
      ...
      before do
        ...
        stub_request(:get, "#{ENV['ARTEMIS_BASE_URI']}/api/v3/facilities/1568/batches/96182?include=zone,zone.sub_stage,barcodes,custom_data,seeding_unit,harvest_unit,sub_zone,custom_data.custom_field")
